...
!function getNameFromUrl(){
    ...
    async function createRoom() {
      ...
      // Code for inviting other to room below
        ...
        db.collection("Chats").where("Room", "==", chatName).get().then(querySnapshot => {
    ...
    async function openUserMedia(e) {
      ...
      const remoteVideoStream = document.createElement("video")
        remoteVideoStream.setAttribute("autoplay", "true")
        remoteVideoStream.setAttribute("playsinlined", "true")

      remoteVideoStream.srcObject = remoteStream;
    
      document.querySelector('#videos').appendChild(remoteVideoStream)
